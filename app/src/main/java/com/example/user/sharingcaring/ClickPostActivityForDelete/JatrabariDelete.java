...
public class JatrabariDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jatrabari_delete);

        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        postKey=getIntent().getExtras().get("PostKey").toString();
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("JatrabariPosts").child(postKey);


        delAboutText=findViewById(R.id.jatrabari_ride_about_del);
        delLocationText=findViewById(R.id.jatrabari_location_del);
        delPhnNumberText=findViewById(R.id.jatrabari_phn_del);
        delTimeText=findViewById(R.id.jatrabari_time_del);

        callNowButton=findViewById(R.id.jatrabari_callNow);
        deletePostButton=findViewById(R.id.jatrabari_delete);
    ...
    private void postActivity() {
        Intent bookIntent=new Intent(JatrabariDelete.this,JatrabariRidePosts.class);
