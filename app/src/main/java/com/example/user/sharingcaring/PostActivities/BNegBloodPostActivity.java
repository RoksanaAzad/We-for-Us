...
public class BNegBloodPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bneg_blood_post);
        ...
        bloodAbout=findViewById(R.id.bNeg_blood_about);
        bloodGroup=findViewById(R.id.bNeg_blood_group);
        bloodNeeded=findViewById(R.id.bNeg_blood_needed);
        bloodLocation=findViewById(R.id.bNeg_blood_location);
        postButton=findViewById(R.id.bNeg_blood_post_button);
        bloodPhoneNumber=findViewById(R.id.bNeg_blood_phoneNumber);
    ...
    private void validatePost() {
        ...
        if (TextUtils.isEmpty(about)){
            Toast.makeText(BNegBloodPostActivity.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToBNegBlood();
                                Toast.makeText(BNegBloodPostActivity.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(BNegBloodPostActivity.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToBNegBlood() {
        Intent intent=new Intent(BNegBloodPostActivity.this,Bnegative.class);
