...
public class BPosBloodPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpos_blood_post);
        ...
        bloodAbout=findViewById(R.id.bPos_blood_about);
        bloodGroup=findViewById(R.id.bPos_blood_group);
        bloodNeeded=findViewById(R.id.bPos_blood_needed);
        bloodLocation=findViewById(R.id.bPos_blood_location);
        postButton=findViewById(R.id.bPos_blood_post_button);
        bloodPhoneNumber=findViewById(R.id.bPos_blood_phoneNumber);
    ...
    private void validatePost() {
        ...
        String blood_phoneNumber=bloodLocation.getText().toString();

        if (TextUtils.isEmpty(about)){
            Toast.makeText(BPosBloodPostActivity.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
        ...
        userRef.child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    String blood_number=bloodGroup.getText().toString();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToBNegBlood();
                                Toast.makeText(BPosBloodPostActivity.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(BPosBloodPostActivity.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToBNegBlood() {
        Intent intent=new Intent(BPosBloodPostActivity.this,Bpositive.class);
