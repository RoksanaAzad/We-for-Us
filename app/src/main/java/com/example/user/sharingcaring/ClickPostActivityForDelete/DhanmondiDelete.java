...
public class DhanmondiDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhanmondi_delete);

        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        postKey=getIntent().getExtras().get("PostKey").toString();
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("DhanmondiPosts").child(postKey);


        delAboutText=findViewById(R.id.dhanmondi_ride_about_del);
        delLocationText=findViewById(R.id.dhanmondi_location_del);
        delPhnNumberText=findViewById(R.id.dhanmondi_phn_del);
        delTimeText=findViewById(R.id.dhanmondi_time_del);

        callNowButton=findViewById(R.id.dhanmondi_callNow);
        deletePostButton=findViewById(R.id.dhanmondi_delete);
    ...
    private void postActivity() {
        Intent bookIntent=new Intent(DhanmondiDelete.this,DhanmondiRidePosts.class);
