...
public class OldDhakaDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_dhaka_delete);
        ...
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("OldDhakaPosts").child(postKey);


        delAboutText=findViewById(R.id.oldDhaka_ride_about_del);
        delLocationText=findViewById(R.id.oldDhaka_location_del);
        delPhnNumberText=findViewById(R.id.oldDhaka_phn_del);
        delTimeText=findViewById(R.id.oldDhaka_time_del);

        callNowButton=findViewById(R.id.oldDhaka_callNow);
        deletePostButton=findViewById(R.id.oldDhaka_delete);
    ...
    private void postActivity() {
        Intent bookIntent=new Intent(OldDhakaDelete.this,OldDhakaRidePost.class);
