...
public class BPositiveDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpositive_delete);

        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        postKey=getIntent().getExtras().get("PostKey").toString();
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("BPositiveBloodPosts").child(postKey);

        delDescText=findViewById(R.id.about_Bpos_blood_del);
        delLocationText=findViewById(R.id.location_Bpos_blood_del);
        delPhnNumberText=findViewById(R.id.phnNumber_Bpos_blood_del);
        callNowButton=findViewById(R.id.call_now_Bpos_button);
        deletePostButton=findViewById(R.id.delete_Bpos_post_button);
    ...
    private void bloodActivty() {
        Intent bookIntent=new Intent(BPositiveDelete.this,Bpositive.class);
