...
public class OldDhaka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_dhaka);
        ...
        writeAboutUrRide=findViewById(R.id.oldDhaka_ride_about);
        exactLocation=findViewById(R.id.oldDhaka_ride_location);
        rideTime=findViewById(R.id.oldDhaka_ride_time);
        phoneNumber=findViewById(R.id.oldDhaka_ride_phone);

        ridePostButton=findViewById(R.id.oldDhaka_ride_post_button);
    ...
    private void validatePost() {
        ...
        if (TextUtils.isEmpty(ride_desc)){
            Toast.makeText(OldDhaka.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToOldDhakaRide();
                                Toast.makeText(OldDhaka.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(OldDhaka.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToOldDhakaRide() {
        Intent intent=new Intent(OldDhaka.this,OldDhakaRidePost.class);
