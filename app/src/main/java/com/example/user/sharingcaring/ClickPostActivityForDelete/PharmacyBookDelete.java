...
public class PharmacyBookDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacy_book_delete);
        ...
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("PharmacyBookPosts").child(postKey);

        editDescText=findViewById(R.id.edit_phr_desc_Text);
        editLocationText=findViewById(R.id.edit_phr_location_Text);
        editPhnNumberText=findViewById(R.id.edit_phr_phoneNumber_Text);
        editPostImage=findViewById(R.id.edit_phr_book_image_view);
        callNowButton=findViewById(R.id.call_now_phr_button);
        deletePostButton=findViewById(R.id.delete_phr_post_button);
    ...
    private void bookActivity() {
        Intent bookIntent=new Intent(PharmacyBookDelete.this,PharmacyActivity.class);
