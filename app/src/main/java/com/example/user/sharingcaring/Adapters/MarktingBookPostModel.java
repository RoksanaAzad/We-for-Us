...
public class MarktingBookPostModel {

    public String date,description,location,fullname,postimage,profileimage,time,uid,phoneNumber;

    public MarktingBookPostModel() {
    }

    public MarktingBookPostModel(String date, String description, String location, String fullname,
