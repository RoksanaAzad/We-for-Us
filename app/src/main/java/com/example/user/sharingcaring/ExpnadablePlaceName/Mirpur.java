...
public class Mirpur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writeAboutUrRide=findViewById(R.id.mirpur_ride_about);
        exactLocation=findViewById(R.id.mirpur_ride_location);
        rideTime=findViewById(R.id.mirpur_ride_time);
        phoneNumber=findViewById(R.id.mirpur_ride_phone);

        ridePostButton=findViewById(R.id.mirpur_ride_post_button);
    ...
    private void validatePost() {
        ...
        if (TextUtils.isEmpty(ride_desc)){
            Toast.makeText(Mirpur.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToMirpuriRide();
                                Toast.makeText(Mirpur.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(Mirpur.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToMirpuriRide() {
        Intent intent=new Intent(Mirpur.this,MirpurRidePosts.class);
