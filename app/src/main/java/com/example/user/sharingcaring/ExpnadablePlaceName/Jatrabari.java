...
public class Jatrabari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jatrabari);
        ...
        writeAboutUrRide=findViewById(R.id.jatrabari_ride_about);
        exactLocation=findViewById(R.id.jatrabari_ride_location);
        rideTime=findViewById(R.id.jatrabari_ride_time);
        phoneNumber=findViewById(R.id.jatrabari_ride_phone);

        ridePostButton=findViewById(R.id.jatrabari_ride_post_button);
    ...
    private void validatePost() {
        ...
        if (TextUtils.isEmpty(ride_desc)){
            Toast.makeText(Jatrabari.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToJatrabaridiRide();
                                Toast.makeText(Jatrabari.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(Jatrabari.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToJatrabaridiRide() {
        Intent intent=new Intent(Jatrabari.this,JatrabariRidePosts.class);
