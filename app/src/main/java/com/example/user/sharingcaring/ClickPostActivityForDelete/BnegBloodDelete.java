...
public class BnegBloodDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bneg_blood_delete);
        ...
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("BNegativeBloodPosts").child(postKey);

        delDescText=findViewById(R.id.about_Bneg_blood_del);
        delLocationText=findViewById(R.id.location_Bneg_blood_del);
        delPhnNumberText=findViewById(R.id.phnNumber_Bneg_blood_del);
        callNowButton=findViewById(R.id.call_now_Bneg_button);
        deletePostButton=findViewById(R.id.delete_Bneg_post_button);
    ...
    private void bloodActivty() {
        Intent bookIntent=new Intent(BnegBloodDelete.this,Bnegative.class);
