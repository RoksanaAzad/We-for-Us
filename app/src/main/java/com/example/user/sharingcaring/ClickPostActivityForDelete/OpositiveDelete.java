...
public class OpositiveDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opositive_delete);

        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        postKey=getIntent().getExtras().get("PostKey").toString();
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("OPositiveBloodPosts").child(postKey);

        delDescText=findViewById(R.id.about_Opos_blood_del);
        delLocationText=findViewById(R.id.location_Opos_blood_del);
        delPhnNumberText=findViewById(R.id.phnNumber_Opos_blood_del);
        callNowButton=findViewById(R.id.call_now_Opos_button);
        deletePostButton=findViewById(R.id.delete_Opos_post_button);
    ...
    private void bloodActivty() {
        ...
        Intent bookIntent=new Intent(OpositiveDelete.this,Opositive.class);
