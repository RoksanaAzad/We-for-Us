...
public class OnegBloodPostActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oneg_blood_post_activty);
        ...
        bloodAbout=findViewById(R.id.oNeg_blood_about);
        bloodGroup=findViewById(R.id.oNeg_blood_group);
        bloodNeeded=findViewById(R.id.oNeg_blood_needed);
        bloodLocation=findViewById(R.id.oNeg_blood_location);
        postButton=findViewById(R.id.oNeg_blood_post_button);
        bloodPhoneNumber=findViewById(R.id.oNeg_blood_phoneNumber);
    ...
    private void validatePost() {
        ...
        String blood_phnNumber=bloodPhoneNumber.getText().toString();

        if (TextUtils.isEmpty(about)){
            Toast.makeText(OnegBloodPostActivty.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToONegBlood();
                                Toast.makeText(OnegBloodPostActivty.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(OnegBloodPostActivty.this, "Error Occured while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToONegBlood() {
        Intent intent=new Intent(OnegBloodPostActivty.this,Onegative.class);
