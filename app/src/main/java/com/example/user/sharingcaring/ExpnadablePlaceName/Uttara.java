...
public class Uttara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writeAboutUrRide=findViewById(R.id.uttara_ride_about);
        exactLocation=findViewById(R.id.uttara_ride_location);
        rideTime=findViewById(R.id.uttara_ride_time);
        phoneNumber=findViewById(R.id.uttara_ride_phone);

        ridePostButton=findViewById(R.id.uttara_ride_post_button);
    ...
    private void validatePost() {
        ...
        if (TextUtils.isEmpty(ride_desc)){
            Toast.makeText(Uttara.this,"Please, fill up the blank segment",Toast.LENGTH_LONG).show();
                    ...
                    postRef.child(currentUserId + postRandomName).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                //sendUserToMain();
                                sendUserToUttaraRide();
                                Toast.makeText(Uttara.this, "New Post is updated successfully.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }else {
                                Toast.makeText(Uttara.this, "Error Occurred while updating your post.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void sendUserToUttaraRide() {
        Intent intent=new Intent(Uttara.this,UttoraRidePosts.class);
