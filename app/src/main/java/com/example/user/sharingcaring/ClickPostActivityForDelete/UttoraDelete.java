...
public class UttoraDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttora_delete);
        ...
        clickPostRef=FirebaseDatabase.getInstance().getReference().child("UttaraPosts").child(postKey);


        delAboutText=findViewById(R.id.uttora_ride_about_del);
        delLocationText=findViewById(R.id.uttora_location_del);
        delPhnNumberText=findViewById(R.id.uttora_phn_del);
        delTimeText=findViewById(R.id.uttora_time_del);

        callNowButton=findViewById(R.id.uttora_callNow);
        deletePostButton=findViewById(R.id.uttora_delete);
    ...
    private void postActivity() {
        Intent bookIntent=new Intent(UttoraDelete.this,UttoraRidePosts.class);
